    ...
    >
      <aside className="dashboard-sidebar">
        ...
        <div className="watch-status">
          ...
          <span>
            Next SAR pass 09:42 UTC · Sentinel-1A
          </span>
        </div>
          ...
          {module === "Dashboard" ? (
            <>
              ...
              >
                <div>
                  <small>
                    OPERATIONAL WATCH · WEST & EAST COAST
                  </small>

                  <h1>Incident overview</h1>

                  <p>
                    Six incidents under management.
                    OSI-2418 remains the controlling
                    event with forecast shoreline
                    contact inside 15 hours.
                  </p>
                </div>
              ...
              <div className="dashboard-grid">
                <section className="dashboard-card map-card">
                  <div className="card-header">
                    <div>
                      <h2>
                        Maritime monitoring — Gulf of
                        Khambhat
                      </h2>

                      <p>
                        Sentinel-1A 06:02 UTC · slick
                        extent, forecast track and
                        response assets
                      </p>
                    </div>
